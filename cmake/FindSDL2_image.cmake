if(WIN32)
    ...
    find_path(SDL2_IMAGE_ROOT "include/SDL.h" PATHS "${CMAKE_CURRENT_LIST_DIR}/../SDL" NO_DEFAULT_PATH)
    if(SDL2_IMAGE_ROOT)
        if (EXISTS "${SDL2_IMAGE_ROOT}/lib/SDL2_image.lib")
            set(SDL2_IMAGE_INCLUDE_DIRS "${SDL2_IMAGE_ROOT}/include")
            set(SDL2_IMAGE_LIBS "${SDL2_IMAGE_ROOT}/lib/SDL2_image.lib")
            set(SDL2_IMAGE_DLLS "${SDL2_IMAGE_ROOT}/lib/SDL2_image.dll")
        endif()
    endif()

    mark_as_advanced(SDL2_IMAGE_ROOT)
    find_package_handle_standard_args(SDL2_IMAGE DEFAULT_MSG SDL2_IMAGE_INCLUDE_DIRS SDL2_IMAGE_LIBS SDL2_DLLS)
else()
