if(WIN32)
    ...
    find_path(SDL2_MIXER_ROOT "include/SDL.h" PATHS "${CMAKE_CURRENT_LIST_DIR}/../SDL" NO_DEFAULT_PATH)
    if(SDL2_MIXER_ROOT)
        if (EXISTS "${SDL2_MIXER_ROOT}/lib/SDL2_mixer.lib")
            set(SDL2_MIXER_INCLUDE_DIRS "${SDL2_MIXER_ROOT}/include")
            set(SDL2_MIXER_LIBS "${SDL2_MIXER_ROOT}/lib/SDL2_mixer.lib")
            set(SDL2_MIXER_DLLS "${SDL2_MIXER_ROOT}/lib/SDL2_mixer.dll")
        endif()
    endif()

    mark_as_advanced(SDL2_MIXER_ROOT)
    find_package_handle_standard_args(SDL2_MIXER DEFAULT_MSG SDL2_MIXER_INCLUDE_DIRS SDL2_MIXER_LIBS SDL2_DLLS)
else()
